...
FalknerGroup:
	...
	db 13, SPEAROW,		NO_ITEM,	PECK, LEER, FURY_ATTACK, MUD_SLAP
	db 13, NATU, 		NO_ITEM,	PECK, LEER, NIGHT_SHADE, NO_MOVE
	db 16, HOOTHOOT,	NO_ITEM,	PECK, HYPNOSIS, FORESIGHT, MUD_SLAP
	db 18, PIDGEOTTO,	GOLD_BERRY,	QUICK_ATTACK, SAND_ATTACK, GUST, MUD_SLAP
	db -1 ; end
...
BugsyGroup:
	...
	db 15, PINECO,  	NO_ITEM, 		ROLLOUT, DEFENSE_CURL, SELFDESTRUCT, PIN_MISSILE
	db 17, SPINARAK,    NO_ITEM, 		NIGHT_SHADE, POISON_STING, SCARY_FACE, CUT
	db 18, LEDIAN,		NO_ITEM,		THUNDERPUNCH, COMET_PUNCH, SUPERSONIC, NO_MOVE
	db 20, HERACROSS,	NO_ITEM,		CUT, KARATE_CHOP, FURY_CUTTER, HORN_ATTACK
	db 20, SHUCKLE,		BERRY_JUICE,	WITHDRAW, WRAP, ENCORE, FLASH
	db 24, SCIZOR,    	GOLD_BERRY,		FURY_CUTTER, PURSUIT, QUICK_ATTACK, FOCUS_ENERGY
	db -1 ; end
...
YoungsterGroup:
	...
	; YOUNGSTER (7)
	; ROUTE 30 GOLDENROD REMATCH
	db "JOEY@", TRAINERTYPE_NORMAL
	db 15, RATTATA
	db -1 ; end

	; YOUNGSTER (8)
	; ROUTE 30 OLIVINE REMATCH
...
BirdKeeperGroup:
	...
	db  11, HOOTHOOT,	TACKLE, GROWL, PECK, MUD_SLAP
	db -1 ; end

	; BIRD_KEEPER (2)
	; VIOLET CITY GYM
	db "ABE@", TRAINERTYPE_MOVES
	db  12, SPEAROW,	PECK, LEER, GROWL, MUD_SLAP
	db -1 ; end
...
BugCatcherGroup:
	...
	db 14, SCYTHER,	QUICK_ATTACK, PURSUIT, FOCUS_ENERGY, FURY_CUTTER
	db 14, PINSIR,	FURY_CUTTER, VICEGRIP, FOCUS_ENERGY, BIND
	db -1 ; end
...
SageGroup:
	...
	; SAGE (9)
	; SPROUT TOWER 3F BOSS
	db "LI@", TRAINERTYPE_MOVES
	db  9, GASTLY,		HYPNOSIS, LICK, SPITE, NO_MOVE
	db 11, BELLSPROUT,	VINE_WHIP, GROWTH, WRAP, FLASH
	db 11, BELLSPROUT,	VINE_WHIP, GROWTH, WRAP, FLASH
	db 13, HOOTHOOT,	TACKLE, FLASH, FORESIGHT, PECK
	db -1 ; end
