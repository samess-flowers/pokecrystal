...
SlowpokeEvosAttacks:
	db EVOLVE_STAT, 37, DEF_GT_SPDEF, SLOWBRO
	db EVOLVE_STAT, 37, DEF_EQ_SPDEF, SLOWBRO ; tiebreaker
	db EVOLVE_STAT, 37, DEF_LT_SPDEF, SLOWKING
	db 0 ; no more evolutions
	db 1, CURSE
	db 1, TACKLE
	db 6, GROWL
...
PorygonEvosAttacks:
	db EVOLVE_HAPPINESS, TR_ANYTIME, PORYGON2
	db 0 ; no more evolutions
	db 1, CONVERSION2
	db 1, TACKLE
	db 1, CONVERSION
