...
WhitneyGroup:
	...
	db 18, CLEFAIRY,   DOUBLESLAP, MIMIC, DRAIN_KISS, METRONOME
...
WillGroup:
	...
	db 76, SLOWKING,   AMNESIA, SURF, PSYCHIC_M, FIRE_BLAST
	db 76, SLOWBRO,	   CURSE, BODY_SLAM, IRON_TAIL, EARTHQUAKE
	db 76, JYNX,       DREAM_EATER, LOVELY_KISS, ICE_BEAM, PSYCHIC_M
	db 76, EXEGGUTOR,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 75, WOBBUFFET,  COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 80, XATU,       DRILL_PECK, GIGA_DRAIN, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
PKMNTrainerGroup:
	...
	db 90, KINGDRA, 	SCOPE_LENS,		OCTAZOOKA, DRAGONBREATH, ICE_BEAM, REST
	db 90, TYRANITAR,	BERSERK_GENE,	ROCK_SLIDE, EARTHQUAKE, CRUNCH, HYPER_BEAM
	db 90, AMPHAROS, 	QUICK_CLAW,		THUNDERBOLT, ZAP_CANNON, REFLECT, BODY_SLAM
	db 90, MEGANIUM,	MIRACLE_SEED,	SOLARBEAM, BODY_SLAM, LIGHT_SCREEN, SUNNY_DAY
	db 90, TYPHLOSION,	CHARCOAL,		DOUBLE_TEAM, THUNDERPUNCH, FIRE_BLAST, SWIFT
	db 90, FERALIGATR,	MYSTIC_WATER,	SURF, RAIN_DANCE, SLASH, EARTHQUAKE
	db -1 ; end

BrunoGroup:
	; BRUNO (1)
	db "BRUNO@", TRAINERTYPE_MOVES
	db 77, HITMONTOP,  PURSUIT, TRIPLE_KICK, MACH_PUNCH, DETECT
	db 77, HITMONLEE,  REVERSAL, MEGA_KICK, HI_JUMP_KICK, FORESIGHT
	db 77, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 78, STEELIX,    IRON_TAIL, EARTHQUAKE, CRUNCH, ROCK_SLIDE
	db 78, HERACROSS,  MEGAHORN, COUNTER, CURSE, EARTHQUAKE
	db 80, MACHAMP,    ROCK_SLIDE, FORESIGHT, THUNDERPUNCH, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 77, UMBREON,    MOONLIGHT, TOXIC, FAINT_ATTACK, ATTRACT
	db 77, VILEPLUME,  STUN_SPORE, SLUDGE_BOMB, MOONLIGHT, PETAL_DANCE
	db 80, GENGAR,     SHADOW_BALL, THUNDERBOLT, CURSE, DESTINY_BOND
	db 79, MURKROW,    DRILL_PECK, MIRROR_MOVE, PURSUIT, HAZE
	db 79, SNEASEL,	   METAL_CLAW, BEAT_UP, DETECT, SWAGGER
	db 80, HOUNDOOM,   SUNNY_DAY, PURSUIT, FLAMETHROWER, CRUNCH
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 78, FORRETRESS, PROTECT, TOXIC, BIDE, SPIKES
	db 75, ARIADOS,    DOUBLE_TEAM, AGILITY, BATON_PASS, SLUDGE_BOMB
	db 76, VENOMOTH,   STUN_SPORE, GIGA_DRAIN, PSYCHIC_M, SLUDGE_BOMB
	db 77, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, GIGA_DRAIN
	db 77, TENTACRUEL, SURF, BARRIER, SLUDGE_BOMB, TOXIC
	db 80, CROBAT,     TOXIC, BITE, DOUBLE_TEAM, FLY
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 84, GYARADOS,   RAIN_DANCE, SURF, THUNDER, HYPER_BEAM
	db 87, TYRANITAR,  EARTHQUAKE, CRUNCH, OUTRAGE, HYPER_BEAM
	db 87, DRAGONITE,  THUNDER_WAVE, LIGHT_SCREEN, BLIZZARD, HYPER_BEAM
	db 86, AERODACTYL, SKY_ATTACK, ANCIENTPOWER, IRON_TAIL, HYPER_BEAM
	db 86, CHARIZARD,  FLAMETHROWER, FLY, OUTRAGE, HYPER_BEAM
	db 90, DRAGONITE,  FIRE_BLAST, BLIZZARD, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
Rival2Group:
	...
	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 75, SNEASEL,    METAL_CLAW, BEAT_UP, DETECT, SWAGGER
	db 78, CROBAT,     TOXIC, BITE, DOUBLE_TEAM, FLY
	db 75, MAGNETON,   THUNDER, TRI_ATTACK, THUNDER_WAVE, RAIN_DANCE
	db 76, GENGAR,     SHADOW_BALL, ICE_PUNCH, PSYCHIC_M, DESTINY_BOND
	db 76, ALAKAZAM,   RECOVER, FIRE_PUNCH, PSYCHIC_M, REFLECT
	db 80, MEGANIUM,   SOLARBEAM, BODY_SLAM, LIGHT_SCREEN, SUNNY_DAY
	db -1 ; end
	...
	db 76, GENGAR,     SHADOW_BALL, ICE_PUNCH, PSYCHIC_M, DESTINY_BOND
	db 76, ALAKAZAM,   RECOVER, FIRE_PUNCH, PSYCHIC_M, REFLECT
	db 80, TYPHLOSION, DOUBLE_TEAM, THUNDERPUNCH, FIRE_BLAST, SWIFT
	db -1 ; end
	...
	db 76, GENGAR,     SHADOW_BALL, ICE_PUNCH, PSYCHIC_M, DESTINY_BOND
	db 76, ALAKAZAM,   RECOVER, FIRE_PUNCH, PSYCHIC_M, REFLECT
	db 80, FERALIGATR, SURF, RAIN_DANCE, SLASH, EARTHQUAKE
	db -1 ; end
...
PicnickerGroup:
	...
	db 31, CLEFAIRY,   ENCORE, SING, DRAIN_KISS, MINIMIZE
	db -1 ; end

	; PICNICKER (17)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 37, CLEFAIRY,   ENCORE, DRAIN_KISS, MINIMIZE, METRONOME
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, CLEFAIRY,   ENCORE, DRAIN_KISS, DOUBLESLAP, MINIMIZE
	db -1 ; end
	...
	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 46, CLEFAIRY,   METRONOME, MOONBLAST, MOONLIGHT, MINIMIZE
	db -1 ; end
...
TwinsGroup:
	...
	db 16, CLEFAIRY,   DRAIN_KISS, ENCORE, DOUBLESLAP, METRONOME
...
RedGroup:
	...
	db 93,	ESPEON,	    BRIGHTPOWDER,	DOUBLE_TEAM, SHADOW_BALL, MORNING_SUN, PSYCHIC_M
	db 95,	SNORLAX,    LEFTOVERS,		CURSE, EARTHQUAKE, REST, BODY_SLAM
	db 97,	VENUSAUR,   MIRACLE_SEED,	SUNNY_DAY, RETURN, SYNTHESIS, SOLARBEAM
	db 97,	CHARIZARD,  CHARCOAL,		FLAMETHROWER, STEEL_WING, DRAGONBREATH, EARTHQUAKE
	db 97,	BLASTOISE,  MYSTIC_WATER,	RAIN_DANCE, SURF, BLIZZARD, SKULL_BASH
	db 100,	PIKACHU,    LIGHT_BALL,		BODY_SLAM, REFLECT, THUNDERBOLT, THUNDER
	db -1 ; end
